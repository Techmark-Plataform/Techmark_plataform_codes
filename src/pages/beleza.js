            ...
            <div className={styles.content_commerce}>
               ...
               <div className={styles.card}>
                  ...
                  <div className={styles.box_info}>
                     <p className={styles.category}>Beleza</p>

                     <h2 className={styles.title}>Raquel Sobrancelhas</h2>
                     ...
                     <p className={styles.street_number}>Número: 456</p>
               ...
               <div className={styles.card}>
                  ...
                  <div className={styles.box_info}>
                     ...
                     <h2 className={styles.title}>Barbearia da Bárbara</h2>
                     <div className={styles.box_stars}>
                        <img src={estrela} />
                        <img src={estrela} />
                        <img src={estrela} />
                     ...
                     <p className={styles.street}>Rua: Alameda das begonias</p>
                     <p className={styles.street_number}>Número: 867</p>
