...
<h3 class="card-title"><a href="#">Lan House do Emerson</a></h3>
...
<div class="card-body">
     <p class="card-text_negocio">Mercados</p>
<h3 class="card-title"><a href="#">Quitanda de banda</a></h3>
<div className="Estrela">
<img className="avaliacao" src={estrela} alt="" />
<img className="avaliacao" src={estrela} alt="" />
<img className="avaliacao" src={estrela} alt="" />
...
<div class="card-body">
     <p class="card-text_negocio">Beleza</p>
<h3 class="card-title"><a href="#">Raquel Sobrancelhas</a></h3>
<div className="Estrela">
<img className="avaliacao" src={estrela} alt="" />
<img className="avaliacao" src={estrela} alt="" />
<img className="avaliacao" src={estrela} alt="" />
...
<div class="card-body">
     <p class="card-text_negocio">Restaurantes</p>
<h3 class="card-title"><a href="#">Espetinhos Churrascada</a></h3>
<div className="Estrela">
<img className="avaliacao" src={estrela} alt="" />
<img className="avaliacao" src={estrela} alt="" />
<img className="avaliacao" src={estrela} alt="" />
...
<div class="card-body">
     <p class="card-text_negocio">Restaurante</p>
<h3 class="card-title"><a href="#">Bom confeito</a></h3>
<div className="Estrela">
<img className="avaliacao" src={estrela} alt="" />
<img className="avaliacao" src={estrela} alt="" />
<img className="avaliacao" src={estrela} alt="" />
...
<div class="card-body">
     <p class="card-text_negocio">Roupas</p>
<h3 class="card-title"><a href="#">Passe e compre</a></h3>
<div className="Estrela">
<img className="avaliacao" src={estrela} alt="" />
<img className="avaliacao" src={estrela} alt="" />
<img className="avaliacao" src={estrela} alt="" />
